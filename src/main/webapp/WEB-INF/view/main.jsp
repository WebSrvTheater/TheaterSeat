                ...
                <div class="side-menu-container">
                    <ul class="nav navbar-nav" style="height: 90%; width: 100%; overflow:auto;">
                        ...
                        <li><a href="/login" target="content"><span class="glyphicon glyphicon-user"></span> 로그인
                                <% } else { %>
                        <li><a href="/logout" target="content" id="logout"><span class="glyphicon glyphicon-off"></span>
                                로그아웃
                                <% } %></a></li>
                   ...
                   RoomMapper roomMapper = (RoomMapper) request.getAttribute("roomMapper"); %>
                                    ...
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li class="panel panel-default" id="dropdown">
                                            <a data-toggle="collapse" href="#dropdown-lvl<%= i+2 %>">
                                                ...
                                                <%= theaterName %> <span class="caret"></span>
                                            </a>
                                            <!-- 상영관에 따른 드롭다운 레벨 구분 -->
                                            <div id="dropdown-lvl<%= i+2 %>" class="panel-collapse collapse">
                                                <div class="panel-body">
                                                    <ul class="nav navbar-nav">
                                                        ...
                                                        <% if(roomMapper.selectAllSeats(r_idx).size() > 0) { %>
                                                        <%-- DB에 좌석 정보가 있는 상영관만 출력 --%>
                                                        <li class="roomlist">
                                                            <%-- 클릭시 r_idx에 해당하는 상영관 정보를 메인페이지에 전시 --%>
                                                            <a href="/room/<%=r_idx%>" class="seat" target="content">
                                                                <%= roomMap.get(r_idx) %></a>
                                                        </li>
                                                        <% } %>
                                                        <% } %>
